...
public class CadFuncionario extends JFrame{
        ...
        private JLabel lbNome, lbCpf, lbDNasc, lbSalario;
        private JTextField txtNome, txtCpf, txtDNasc, txtSalario;
        ...
        public void tela(){
            ...
            this.comBox.setSelectedIndex(3);
            ...
            this.insTela(4, 0, this.lbSalario);
            this.insTela(4, 1, this.txtSalario);
